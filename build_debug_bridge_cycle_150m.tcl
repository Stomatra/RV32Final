...
set build_dir [file join $origin_dir "debug_bridge_cycle_150m_build"]
set synth_dcp [file join $build_dir "top_debug_bridge_cycle_synth.dcp"]
set debug_bit [file join $origin_dir "top_debug_bridge_cycle_withoutmext_irom_v2_150m.bit"]
set timing_rpt [file join $origin_dir "timing_debug_bridge_cycle_150m.rpt"]
set paths_rpt [file join $origin_dir "timing_debug_bridge_cycle_150m_paths.rpt"]
set summary_txt [file join $origin_dir "timing_debug_bridge_cycle_150m_summary.txt"]
...
set_property verilog_define {DEBUG_BRIDGE_CYCLE} [current_fileset]

read_verilog -sv $sources
read_verilog $irom_stub
read_verilog $pll_stub

puts "DEBUG_DEFINE=DEBUG_BRIDGE_CYCLE"
...
puts $fp "DEBUG_DEFINE=DEBUG_BRIDGE_CYCLE"
