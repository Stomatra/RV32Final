...
upgrade_ip $pll_ip
set_property -dict [list CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100.000}] $pll_ip
...
open_run impl_1
report_clocks -file {d:/digital_twin/digital_twin/openrun_impl_clocks_100m.rpt}
report_timing_summary -max_paths 10 -file {d:/digital_twin/digital_twin/openrun_top_timing_impl_100m.rpt}
report_utilization -file {d:/digital_twin/digital_twin/openrun_top_utilization_impl_100m.rpt}
close_project
exit