...
set out_dir [file join $project_root "z_b_small_build_outputs"]
set final_dir [file join $project_root "final_bits"]
set stamp [clock format [clock seconds] -format "%Y%m%d_%H%M%S"]
set build_tag "Z_B_SMALL_TEST_200MHz_${stamp}"

set root_bit [file join $project_root "Z_B_SMALL_TEST_200MHz.bit"]
