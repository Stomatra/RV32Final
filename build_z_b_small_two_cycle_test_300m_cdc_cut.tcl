...
set out_dir [file join $project_root "z_b_small_two_cycle_300m_cdc_cut_build_outputs"]
set final_dir [file join $project_root "final_bits"]
set stamp [clock format [clock seconds] -format "%Y%m%d_%H%M%S"]
set build_tag "Z_B_SMALL_TWO_CYCLE_TEST_300MHz_${stamp}"

set root_bit [file join $project_root "Z_B_SMALL_TWO_CYCLE_TEST_300MHz.bit"]
set final_bit [file join $final_dir "${build_tag}.bit"]
set summary_md [file join $project_root "Z_B_SMALL_TWO_CYCLE_300M_REPORT.md"]
...
puts $md "# Z_B_SMALL_TWO_CYCLE_300M_REPORT"
puts $md ""
