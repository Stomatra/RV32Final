...
set build_dir [file join $origin_dir "debug_milestone_150m_build"]
set synth_dcp [file join $build_dir "top_debug_milestone_synth.dcp"]
set debug_bit [file join $origin_dir "top_debug_milestone_150m.bit"]
set timing_rpt [file join $origin_dir "timing_debug_milestone_150m.rpt"]
set paths_rpt [file join $origin_dir "timing_debug_milestone_150m_paths.rpt"]
set summary_txt [file join $origin_dir "timing_debug_milestone_150m_summary.txt"]
...
set_property verilog_define {DEBUG_HW_MILESTONE} [current_fileset]

read_verilog -sv $sources
read_verilog $irom_stub
read_verilog $pll_stub

puts "DEBUG_DEFINE=DEBUG_HW_MILESTONE"
...
# read_checkpoint invalidates previously captured design-object handles.
...
puts $fp "DEBUG_DEFINE=DEBUG_HW_MILESTONE"
