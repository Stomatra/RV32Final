...
module hdmi_colorbar_720p_top (
    ...
    // Primary 720p build assumes the board differential clock is 125 MHz.
    // 125 / 8 * 47.5 = 742.1875 MHz VCO, /10 = 74.21875 MHz pixel,
    // /2 = 371.09375 MHz 5x TMDS clock.
    hdmi_clock_gen_720p #(
        .CLKIN1_PERIOD_NS (8.000),
