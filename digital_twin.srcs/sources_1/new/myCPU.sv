...
module myCPU (
	...
	always_comb begin
		case (exmem_funct3)
			3'b000: mem_load_data = {{24{perip_rdata[7]}}, perip_rdata[7:0]};
			3'b001: mem_load_data = {{16{perip_rdata[15]}}, perip_rdata[15:0]};
			3'b010: mem_load_data = perip_rdata;
			3'b100: mem_load_data = {24'h0, perip_rdata[7:0]};
			3'b101: mem_load_data = {16'h0, perip_rdata[15:0]};
	...
	always_ff @(posedge cpu_clk or posedge cpu_rst) begin
		if (cpu_rst) begin
			...
			memwb_valid <= 1'b0;  // bubble - perip_rdata not yet stable
		end else begin
