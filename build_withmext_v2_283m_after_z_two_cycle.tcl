...
set out_dir [file join $project_root "withmext_283m_after_z_two_cycle_build_outputs"]
set final_dir [file join $project_root "final_bits"]
set stamp [clock format [clock seconds] -format "%Y%m%d_%H%M%S"]
set build_tag "WITHMEXT_V2_283MHz_AFTER_Z_TWO_CYCLE_${stamp}"

set root_bit [file join $project_root "WITHMEXT_V2_283MHz_AFTER_Z_TWO_CYCLE.bit"]
set final_bit [file join $final_dir "${build_tag}.bit"]
set summary_md [file join $project_root "WITHMEXT_V2_283M_AFTER_Z_TWO_CYCLE_REPORT.md"]
...
puts $md "# WITHMEXT_V2_283M_AFTER_Z_TWO_CYCLE_REPORT"
puts $md ""
