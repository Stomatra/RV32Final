...
set out_dir [file join $root_dir "timing_backups" "place_explore_compare_[clock format [clock seconds] -format %Y%m%d_%H%M%S]"]
file mkdir $out_dir

set configs {
    {Explore {place_design -directive Explore}}
    {AggressiveExplore {place_design -directive AggressiveExplore}}
}
