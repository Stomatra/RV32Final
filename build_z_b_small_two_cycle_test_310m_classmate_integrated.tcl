...
set out_dir [file join $project_root "z_b_small_two_cycle_310m_classmate_integrated_build_outputs"]
set final_dir [file join $project_root "final_bits"]
set stamp [clock format [clock seconds] -format "%Y%m%d_%H%M%S"]
set build_tag "Z_B_SMALL_TWO_CYCLE_TEST_310MHz_CLASSMATE_INTEGRATED_${stamp}"

set root_bit [file join $project_root "Z_B_SMALL_TWO_CYCLE_TEST_310MHz_CLASSMATE_INTEGRATED.bit"]
set final_bit [file join $final_dir "${build_tag}.bit"]
set summary_md [file join $project_root "Z_B_SMALL_TWO_CYCLE_310M_CLASSMATE_INTEGRATED_REPORT.md"]
...
set jobs 8
set top_module "top"
set target_freq_mhz 310.000
set expected_irom_sha "D5A762CA186A770E300E3E3B0940B0A6333FB6074F43653EC3361019461B9FFE"
...
puts $md "# Z_B_SMALL_TWO_CYCLE_310M_CLASSMATE_INTEGRATED_REPORT"
puts $md ""
puts $md "This report is for the Z_B_SMALL two-cycle test on the 310MHz classmate integrated baseline."
puts $md ""
...
puts $md "- ENABLE_Z_B_SMALL: on, `verilog_define` = `[get_property verilog_define $fs]`"
...
puts $md "- Board expectation: `LED=0x000003FF`, `SEG=0000000A`."
