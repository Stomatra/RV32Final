...
set out_dir [file join $project_root "withmext_283m_cdc_cut_build_outputs"]
set final_dir [file join $project_root "final_bits"]
set stamp [clock format [clock seconds] -format "%Y%m%d_%H%M%S"]
set build_tag "WITHMEXT_V2_283MHz_CDC_CUT_${stamp}"

set root_bit [file join $project_root "WITHMEXT_V2_283MHz_CDC_CUT.bit"]
set final_bit [file join $final_dir "${build_tag}.bit"]
set summary_md [file join $project_root "WITHMEXT_V2_283M_CDC_CUT_REPORT.md"]
...
puts $md "# WITHMEXT_V2_283M_CDC_CUT_REPORT"
puts $md ""
